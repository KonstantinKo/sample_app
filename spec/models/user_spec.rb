...
describe User do
  ...
  it "should require the email to be unique" do
    first_user = User.create!(@attr.merge(:name => "Jane Doe"))
  ...
  describe "micropost associations" do
    ...
    describe "status feed" do
      ...
      it "should indlude the user's microposts" do
  ...
  describe "relationships" do
    ...
    it "should have a relationhsips method" do
