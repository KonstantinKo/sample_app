...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    before(:each) do
     ...
     it "should paginate microposts" do
       35.times {Factory(:micropost, :user => @user, :content => "Foobar")}
       get :show, :id => @user
       response.should have_selector('div.pagination')
     end
     ...
     it "should display the micropost count" do
       ...
       get :show, :id => @user
       response.should have_selector('li', :content => @user.microposts.count.to_s)
     end
  end
  ...
  describe "GET 'new'" do
   ...
   describe "PUT 'update'" do
     ...
     describe "success" do
       before(:each) do
         @attr = {:name => "Foo Bar", :email => "chunky@bacon.com", 
   ...
   describe "authentication of edit/update actions" do
     ...
     describe "for signed-in users" do
       ...
       before(:each) do
         wrong_user = Factory(:user, :email => "ha@choo.com", :name => "Coo Coo")
